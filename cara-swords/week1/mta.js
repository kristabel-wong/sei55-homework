...
const lines = {
    ...
    singleLineTrip: function(line, startingStation, endingStation){
        ...
        if (line === 'N'){
            ...
            lineArray = this.line6
        }

        const indexOf = lineArray.indexOf(startingStation);
        const indexOfEnd = lineArray.indexOf(endingstation);
