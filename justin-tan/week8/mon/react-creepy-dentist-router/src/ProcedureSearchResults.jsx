...
class ProcedureSearchResults extends React.Component {
    ...
    // when the component is 'mounted', meaning "added to the DOM"
    ...
    // componentWillUnmount is for detaching any weird event handlers
    // you might have attached to the DOM but which are only relevant to this component;
    // you might also use it to 'unsubscribe' from any notifications or 
    // streaming data the component might have started listening to;
    // ie. any cleanup you need to do
    componentWillUnmount(){
        console.log('componentWillUnmount()');
    }

    // This runs after a prop or state is updated,
    // but before the render() - if you return false from it,
    // you can prevent the render
    shouldComponentUpdate(prevProps, prevState){
        console.log('shouldComponentUpdate()');
        return true // to prevent errors
    }

    //This runs AFTER a prop or state is updated, and 
    // after render() - you can use it to see if
    // props have changed ie. search query props from the
    // router - ie. do you need to trigger another AJAX axios.get() request?
    ...
    render(){
        ...
        // runs everytime state updates, and your axios.get()
