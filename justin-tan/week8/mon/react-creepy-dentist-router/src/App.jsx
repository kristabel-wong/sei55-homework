...
// These is no default export from the Router package, so we have to
                ...
                <Router>
                    <header>
                        ...
                        <nav>
                            ...
                            {
                                // We need the Router to render this ProcedureSearch component so we can use the prop 'history' and in particular its push() method, to visit a new route from JS code.

                                // To make sure the component is always visible, i.e. not dependent on a specific path, we can just leave out the "path=" prop.
                            }
