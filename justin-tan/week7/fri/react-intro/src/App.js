...
class App extends React.Component {
  ...
  // a render() which tells the browser
  // what to draw when this component is used
  ...
  render(){
    ...
    return (
      <div className="App">
        ...
        {
          /*
            The below line is really saying: give me an instance (an object) of the HelloUser class, and run its render() method to cause some HTML to be displayed:
