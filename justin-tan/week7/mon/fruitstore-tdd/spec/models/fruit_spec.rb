...
require 'rails_helper' # load up the Rails context for this text file
...
RSpec.describe Fruit, type: :model do
    ...
    # contain just the assertions ( and sometimes specific actions, but as few as possible)
    before do
    ...
    it 'should remembers its class via Single Table Inheritance' do
    ...
    it 'should not consider Fruits to be Pear' do
        ...
        # Add a Fruit and check that it has not changed the number of Pear results
    ...
    it 'should be a squishy (if a Pear)' do
    ...
    it 'should fail validation when created without a name' do
        ...
        # expect(pear.errors.full_messages.length).to be > 0
    ...
    # no description string, and RSpec can work out from context that the "subject" is the Fruit model itself, due to the describe block this example appears in
