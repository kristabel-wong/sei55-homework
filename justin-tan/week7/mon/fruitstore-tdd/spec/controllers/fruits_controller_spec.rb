...
RSpec.describe FruitsController, type: :controller do
    ...
    describe 'GET #index' do
        ...
        # i.e. this one only runs for the 'it' examples related to the "GET #index"
        before do
            ...
            get :index # simulate making a request to fruits#index
        end
        ...
        # QUESTION: has this test become too 'brittle', too dependent on the implementation details of the controller, ie. what the exact instance variable is named?
        ...
        # Management says the fruits should be listed in the reverse order
        ...
        describe 'a fruit with valid information' do
            ...
            before do
                ...
                post :create, params: {
                    fruit: {
                        name: 'Strawberry',
                        shelf: Shelf.create(name: 'test').id
                    }
                }
            end # before
        ...
        describe 'a fruit with invalid information' do
            ...
            before do
                ...
                post :create, params: {
                    fruit: {
                        name: '', # INVALID!
                        sheld_id: Shelf.create(name: 'test').id
                    }
                }
            end
