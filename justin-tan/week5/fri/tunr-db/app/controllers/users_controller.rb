class UsersController < ApplicationController
  ...
  def create
    ...
    if @user.persisted?
      ...
      # instead, we render again the 'new' template, i.e. the blank form, and the form will have access to the '@user' variable, which includes the error messages from AR validation process

      render :new # this does NOT run the new() method above, just shows the template as the template for the current 'create' method
