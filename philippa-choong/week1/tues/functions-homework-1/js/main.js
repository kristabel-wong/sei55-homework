...
const squareNumber = function (aNumber) {
  ...
  return `The result of squaring the number ${aNumber} is ${squaredResult}`;
};
...
const halfNumber = function (aNumber) {
  ...
  return `Half of ${aNumber} is ${halfedResult}`;
};
...
console.log(partTwoSolution(10);
...
const drEvil = function (anAmount){
  ...
  } else if (anAmount >= 1 && anAmount < 1000000){
    return (`${anAmount} dollars`);
  }
};
