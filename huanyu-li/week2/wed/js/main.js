...
//First version is using 'vw' unit to detect the window size: 100vw
//Second version is using 'px' unit.

// The cat can dance with music and random background color (1 per second).

// Please click the cat to start.
// Why? Can't play background music without clicking the page
